...
<body>
    <div class="container-xxl bg-white p-0">
		...
		<%
			...
			String sql = "SELECT * FROM MatForm left JOIN HealthExMat ON MatForm.Mat_SeqNO = HealthExMat.Mat_SeqNO";
			String sql1 = "SELECT * FROM BloodSugarTime";
			String sql2 = "SELECT * FROM MatFeeding";
			String sql3 = "SELECT * FROM StaffForm";
			String sql4 = "SELECT * FROM HealthExMat";
			String sql5 = "SELECT * FROM MatCheckIn";
		...
		<h5 align="right">  <a href="Nurse7.jsp"><button type="button"style="background:#FF9999"> 新增紀錄</button> </a><button type="button"style="background:#D4E1F5"> 列印</button> <a href="Nurse4.jsp"><button type="button"style="background:#FFF2E0">回上一頁</button></a></h5>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                      ...
                      <a class="btn btn-link text-white-50" href="nurse1.html">護理人員首頁</a>
                        <a class="btn btn-link text-white-50" href="nurse2.html">寶寶健康測量紀錄</a>
                        <a class="btn btn-link text-white-50" href="nurse4.html">媽媽健康測量記錄</a>
                        <a class="btn btn-link text-white-50" href="nurse8.html">媽媽基本資料</a>
