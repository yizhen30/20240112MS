                    ...
                    <div class="row g-0">
                        <div class="" data-wow-delay="0.1s" style="min-height: 400px;">
							  ...
							  <tr>
							  	...
							  	<td><%=rs4.getString("MTemp")%>°C</td>
								<td><%=rs4.getString("MWeight")%>kg</td>
								<td><%=rs4.getString("MmmHg")%>mmHg</td>
								<td><%=rs1.getString("BloodSugarTime.Time")%></td>
								<td><%=rs4.getString("MBS")%>mg/dl</td>
								<td><%=rs2.getString("MatFeeding.MatFeeding")%></td>
								<td><%=rs4.getString("MRemark")%></td>
								<td><%=rs4.getString("RecordDate")%></td>
								<td><%=rs4.getString("RecordTime")%></td>
